...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Descanso d2 = new Descanso("Pousada soneca", "Pousada a brisa mar", "Rua da Pestana", 50, new GregorianCalendar(2017, Calendar.MARCH, 10, 20, 0), new GregorianCalendar(2017, Calendar.MARCH, 10, 23, 0), QUALIDADE.BOA);
